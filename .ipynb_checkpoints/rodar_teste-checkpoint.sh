...
python main.py --scale_factor=2 --mode='test' --use_test_set='no' --num_workers=0 --total_step=60000 --model_save_step=1000 --sample_step=100 --num_channels=6 --batch_size=1 --image_size=64 --trained_model=50000.pth.tar --test_image_path='./test_images/0.809_lr_100.png'